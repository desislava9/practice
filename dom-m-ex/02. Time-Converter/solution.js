function attachEventsListeners() {
 ...
 function convertHandler(e) {
    ...
    switch(unit) {
        case "days": propgateNewValue(value); break;
        case "hours": propgateNewValue (value / 24); break;
        case "minutes": propgateNewValue(value / 24 / 60); break;
        case "seconds": propgateNewValue(value / 24 / 60 / 60); break;
    }
    
 }  
 function propgateNewValue(days) {
